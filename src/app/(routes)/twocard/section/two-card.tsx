                        ...
                        <div>
                            ...
                            <ul className="mb-6 space-y-2">
                                <li className="flex items-center">
                                    ...
                                    <span className="ml-2 text-gray-700">식장 : {solutionMessage.basic.hall_address}</span>
                                </li>
                                <li className="flex items-center">
                                    <span className="text-blue-500">&#10003;</span>
                        ...
                        <div>
                            ...
                            <ul className="mb-6 space-y-2">
                                <li className="flex items-center">
                                    ...
                                    <span className="ml-2 text-gray-700">식장 : {solutionMessage.premium.hall_address}</span>
                                </li>
                                <li className="flex items-center">
                                    <span className="text-green-500">&#10003;</span>
